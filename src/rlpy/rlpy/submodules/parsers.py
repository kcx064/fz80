...
# 参数定义
parser.add_argument('--actor_lr', type=float, default=3e-3, help='策略网络的学习率')
parser.add_argument('--critic_lr', type=float, default=3e-2, help='价值网络的学习率')
...
parser.add_argument('--min_size', type=int, default=2000, help='经验池超过200再训练')
parser.add_argument('--batch_size', type=int, default=64, help='每次训练64组样本')
parser.add_argument('--sigma', type=int, default=5, help='高斯噪声标准差')
